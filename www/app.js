...
enyo.path.addPaths({layout: "/e/datos/Dropbox/bin/movil/Prueba/enyo/../lib/layout/", onyx: "/e/datos/Dropbox/bin/movil/Prueba/enyo/../lib/onyx/", onyx: "/e/datos/Dropbox/bin/movil/Prueba/enyo/../lib/onyx/source/"});
...
this.$.main.addContent("-" + logs);
},
deviceReady: function() {
this.log("deviceReady"), milog("deviceReady"), inicio_getFS();
},
salir: function(e, t) {
...
function fallo_fs(e) {
milog("FileSys Error: " + e.code), alert("FileSys Error: " + e.code), navigator.app.exitApp();
}

function inicio_getFS() {
milog("inicio"), window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, function(e) {
e.root.getDirectory("Prueba29", {
create: !0,
exclusive: !1
}, gotDIR, fallo_fs);
}, fallo_fs);
